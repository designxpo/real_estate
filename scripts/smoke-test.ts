...
async function main() {
  const checks: Array<[string, () => Promise<unknown>]> = [
    ...
    ["listingTarget: composite unique field exists", () => prisma.listingTarget.count()],
    ["portalConfig: composite unique field exists", () => prisma.portalConfig.count()],
    ["portalCredential: composite unique field exists", () => prisma.portalCredential.count()],
    ["portalJob: queued count", () => prisma.portalJob.count({ where: { status: "queued" } })],
